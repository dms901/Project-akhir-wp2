                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <p></p>
                                    <?php else: ?>
                                    <img src="<?php echo e(asset('storage/img-produk/img-default.jpg')); ?>" class="foto-preview" width="100%">
                                    <p></p>
                                    <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <?php else: ?>
                                        <option value="<?php echo e($row->id); ?>"> <?php echo e($row->nama_type); ?> </option>
                                        <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_produk" value="<?php echo e(old('nama_produk',$edit->nama_produk)); ?>" class="form-control <?php $__errorArgs = ['nama_produk'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Masukkan Nama Prod">
...
unset($__errorArgs, $__bag); ?>" id="ckeditor"><?php echo e(old('detail',$edit->detail)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    <label>Harga</label>
                                    <input type="text" onkeypress="return hanyaAngka(event)" name="harga" value="<?php echo e(old('harga',$edit->harga)); ?>" class="form-control <?php $__errorArgs = ['harga'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    <label>Berat</label>
                                    <input type="text" onkeypress="return hanyaAngka(event)" name="berat" value="<?php echo e(old('berat', $edit->berat)); ?>" class="form-control <?php $__errorArgs = ['berat'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    <label>Stok</label>
                                    <input type="text" onkeypress="return hanyaAngka(event)" name="stok" value="<?php echo e(old('stok',$edit->stok)); ?>" class="form-control <?php $__errorArgs = ['stok'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('backend.v_layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\TokoOnlineProject\resources\views/backend/v_produk/edit.blade.php ENDPATH**/ ?>