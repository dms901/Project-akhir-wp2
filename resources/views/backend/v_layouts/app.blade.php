                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b class="logo-icon p-l-10">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="{{ asset('backend/images/Toko_online.png') }}" alt="homepage" class="light-logo" width="30" />
                        ...
                        <span class="logo-text">
                            <!-- dark Logo text -->
                            <img src="{{  asset('backend/images/text-line-2.png') }}" alt="homepage" class="light-logo" width="70%" />
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-50">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ route('backend.produk.index') }}" aria-expanded="false"><i class="mdi mdi-shopping"></i><span class="hide-menu">Produk</span></a></li>
                        <li class="sidebar-item"><a href="{{ route('backend.keranjang.index') }}" class="sidebar-link"><i class="mdi mdi-cart"></i><span class="hide-menu"> Keranjang </span></a>
                                </li>
                        @endif
                    </ul>
                </nav>
