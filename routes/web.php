...
Route::get('backend/register', [RegisterController::class, 'registerUser'])->name('backend.register');
Route::post('backend/register', [RegisterController::class, 'createUser'])->name('createUser');
...
//Route keranjang
Route::resource('backend/keranjang', KeranjangController::class, ['as' => 'backend'])->middleware('auth');
