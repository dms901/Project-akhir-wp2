...
<body>
    ...
    <div id="main-wrapper">
        ...
        <header class="topbar" data-navbarbg="skin5">
            <nav class="navbar navbar-dark top-navbar navbar-expand-md">
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b class="logo-icon p-l-10">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="<?php echo e(asset('backend/images/Toko_online.png')); ?>" alt="homepage" class="light-logo" width="30" />
                        ...
                        <span class="logo-text">
                            <!-- dark Logo text -->
                            <img src="<?php echo e(asset('backend/images/text-line-2.png')); ?>" alt="homepage" class="light-logo" width="70%" />
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated">
                                <a class="dropdown-item" href="<?php echo e(route('backend.user.edit', Auth::user()->id)); ?>"><i class="ti-user m-r-5 m-l-5"></i> Profil Saya</a>
        ...
        <aside class="left-sidebar" data-sidebarbg="skin5">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-50">
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo e(route('backend.beranda')); ?>" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu">Beranda</span></a>
                        </li>
                        <?php if(Auth::user()->role==1 or Auth::user()->role==0): ?>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo e(route('backend.user.index')); ?>" aria-expanded="false"><i class="mdi mdi-account"></i><span class="hide-menu">User</span></a>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-shopping"></i><span class="hide-menu">Data Produk </span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><a href="<?php echo e(route('backend.kategori.index')); ?>" class="sidebar-link"><i class="mdi mdi-chevron-right"></i><span class="hide-menu"> Kategori </span></a>
                                </li>
                                <li class="sidebar-item"><a href="<?php echo e(route('backend.produk.index')); ?>" class="sidebar-link"><i class="mdi mdi-chevron-right"></i><span class="hide-menu"> Produk </span></a>
                                </li>
                            </ul>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">Laporan </span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><a href="<?php echo e(route('backend.laporan.formuser')); ?>" class="sidebar-link"><i class="mdi mdi-chevron-right"></i><span class="hide-menu"> User </span></a></li>
                                <li class="sidebar-item"><a href="<?php echo e(route('backend.laporan.formproduk')); ?>" class="sidebar-link"><i class="mdi mdi-chevron-right"></i><span class="hide-menu"> Produk </span></a></li>

                            </ul>
                        </li>
                        <?php elseif(Auth::user()->role==2): ?>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo e(route('backend.produk.index')); ?>" aria-expanded="false"><i class="mdi mdi-shopping"></i><span class="hide-menu">Produk</span></a></li>
                        <li class="sidebar-item"><a href="<?php echo e(route('backend.keranjang.index')); ?>" class="sidebar-link"><i class="mdi mdi-cart"></i><span class="hide-menu"> Keranjang </span></a>
                                </li>
                        <?php endif; ?>
                    </ul>
                </nav>
...
</html><?php /**PATH C:\laragon\www\TokoKendaraanProject\resources\views/backend/v_layouts/app.blade.php ENDPATH**/ ?>